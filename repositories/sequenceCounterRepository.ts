// repositories/sequenceCounterRepository.ts — Phase 2 v2.11 Canonical Repository

import { eq, and } from 'drizzle-orm';
import { db } from '../db/client';
import { sequenceCounters } from '../db/schema';
import { fyRepository } from './fyRepository';
import type { DrizzleTransaction, SequenceCounter, SequenceCounterType } from '../types/phase2.types';
