...
import {
  items, categories, designs, designPurityThresholds, oldGoldLots, financialYears,
  sequenceCounters, itemEvents, stones, gemstoneLots, hsnCodes, urdPurchases,
  looseStockLots, looseStockEvents, designCategoryMap
} from '@/db/schema';
